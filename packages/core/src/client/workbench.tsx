...
const STYLE = `
.luban-workbench-trigger{width:100%;display:flex;align-items:center;gap:9px;border:0;border-radius:8px;padding:10px 12px;color:inherit;background:transparent;cursor:pointer;font:inherit;text-align:left}.luban-workbench-trigger:hover{background:var(--color-bg-hover,#e8edf3)}
.luban-workbench{--lb-bg:var(--color-bg-primary,#f8fafc);--lb-panel:var(--color-bg-secondary,#fff);--lb-text:var(--color-text-primary,#172033);--lb-muted:var(--color-text-secondary,#526177);--lb-border:var(--color-border,#cbd5e1);position:fixed;inset:16px;margin:auto;width:calc(100vw - 32px);height:calc(100dvh - 32px);max-width:1600px;max-height:none;padding:0;border:1px solid var(--lb-border);border-radius:14px;background:var(--lb-bg);color:var(--lb-text);pointer-events:auto;font:14px/1.6 system-ui,sans-serif;overflow:hidden}
...
.luban-workbench__body{display:grid;grid-template-columns:190px minmax(0,1fr);height:calc(100% - 87px)}.luban-workbench__nav{padding:16px 12px;border-right:1px solid var(--lb-border);overflow:auto;background:var(--lb-panel)}.luban-workbench__group{margin:16px 8px 6px;font-size:12px;color:var(--lb-muted)}.luban-workbench__nav button{display:block;width:100%;padding:10px 12px;border:0;border-radius:8px;text-align:left;background:transparent;color:var(--lb-text);margin:3px 0}.luban-workbench__nav button[aria-current=page]{background:#dbeafe;color:#1e40af;font-weight:650}.luban-workbench__content{padding:24px;overflow:auto;min-width:0}.luban-workbench__content>header{margin-bottom:20px}.luban-workbench__content h2{margin:0;font-size:22px}.luban-workbench__description{color:var(--lb-muted);margin:6px 0}.luban-workbench__empty{padding:28px;border:1px dashed var(--lb-border);border-radius:10px}
.luban-workbench :focus-visible{outline:3px solid #60a5fa;outline-offset:3px}
@media(prefers-color-scheme:dark){.luban-workbench{--lb-bg:#101820;--lb-panel:#18232d;--lb-text:#e6edf5;--lb-muted:#a2b1c2;--lb-border:#394958}.luban-workbench__nav button[aria-current=page]{background:#203c59;color:#b5d7ff}}
