...
export class SnippetStore {
  ...
  public async write(
    ...
    const file = join(accountDirectory, `${prefix}-${String(timeFrom)}-${randomUUID()}.log`)
    ...
    return Object.freeze({ accountId, path: file, content: safe, timeFrom, timeTo, endpoint })
  }
}
