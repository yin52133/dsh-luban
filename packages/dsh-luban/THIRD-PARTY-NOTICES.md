...
This aggregate installs but does not copy or modify the following upstream MIT
packages. Their source, licenses, and notices remain in their published packages.
...
approve that build boundary according to their DSH profile policy.
